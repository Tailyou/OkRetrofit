...
public final class Constant {
    ...
    public static final String CONTEXT_NULL_HINT = "Context is NULL! You should call [RxDownload.context(Context context)] first!";
    public static final String DOWNLOAD_URL_EXISTS = "The url download task already exists.";
    public static final String DOWNLOAD_RECORD_FILE_DAMAGED = "Record file may be damaged, so we will re-download";
    ...
    public static final String MULTITHREADING_DOWNLOAD_PREPARE = "MULTITHREADING DOWNLOAD PREPARE...";
    public static final String MULTITHREADING_DOWNLOAD_STARTED = "MULTITHREADING DOWNLOAD STARTED...";
    public static final String MULTITHREADING_DOWNLOAD_COMPLETED = "MULTITHREADING DOWNLOAD COMPLETED!";
    public static final String MULTITHREADING_DOWNLOAD_FAILED = "MULTITHREADING DOWNLOAD FAILED OR CANCEL!";
    ...
    //Range download hint
    public static final String RANGE_DOWNLOAD_STARTED = "[%s] start download! From [%s] to [%s] !";
    public static final String RANGE_DOWNLOAD_COMPLETED = "[%s] download completed!";
    public static final String RANGE_DOWNLOAD_CANCELED = "[%s] download canceled!";
    public static final String RANGE_DOWNLOAD_FAILED = "[%s] download failed or cancel!";
    public static final String RETRY_HINT = "[%s] got an [%s] error! [%d] attempt reconnection!";
